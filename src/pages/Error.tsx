    ...
    <div className='w-full flex flex-col  justify-center items-center h-screen gap-2'>
      ...
      <div className='p-8  text-gray-800 dark:text-white '>
        ...
        <button
          ...
          className='sm:w-full lg:w-auto my-2  flex gap-4 items-center border rounded md py-4 px-8 text-center bg-indigo-600 text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-700 focus:ring-opacity-50'
        >
