                      ...
                      <div className='flex max-w-3xl flex-col space-y-16'>
                        {new_data.isError ? (
                          ...
                          data.map((el: NewType, id: number) => {
                            return (
                              <article className='md:grid md:grid-cols-4 md:items-baseline' key={id}>
                                <div className='md:col-span-3 group relative flex flex-col items-start'>
                                  ...
                                  <p className='relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400'>
                                    we will peek into the fascinating lives of animals, delving into their remarkable
                                    characteristics and the extraordinary ways in which they navigate their
                                    environments. From the graceful movements of marine life in the depths of the ocean
                                    to the impressive feats of birds soaring through the sky, animals captivate us with
                                    their beauty, agility, and innate survival instincts.
                                  </p>
                                  <div
                                    aria-hidden='true'
