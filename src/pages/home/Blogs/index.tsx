...
export default function Blogs() {
  ...
  return (
    <div className='relative flex w-full  min-h-full  backdrop-blur-lg'>
      <img src={BgBlog} alt='background' className='fixed   w-full  z-2 object-cover min-h-full' />
      <div className='fixed w-full   inset-0 flex justify-center sm:px-8 top-32'>
        <div className='flex w-full max-w-7xl lg:px-8 z-7 min-h-fit'>
          <div className='w-full bg-green-200     ring-1 ring-zinc-100 dark:bg-zinc-900 dark:ring-zinc-300/20'></div>
        </div>
      </div>
      <div className='relative flex w-full flex-col z-10  min-h-full '>
        <main className='flex-auto  '>
          <div className='sm:px-8 mt-36 sm:mt-44  mb-36'>
                    ...
                    <div className='mx-auto max-w-2xl'>
                      <header className='max-w-2xl'>
                        ...
                        <p className='mt-6 text-base text-zinc-600 dark:text-zinc-400'>
                          Zoos have long been cherished as places where humans can connect with wildlife from all
                          corners of the globe. These remarkable establishments serve as both educational centers and
                          conservation sanctuaries, offering a unique opportunity to observe and learn about a diverse
                                      ...
                                      <article className=' md:grid md:grid-cols-4 mb-5 md:items-baseline' key={id}>
                                        <div className='md:col-span-3 group relative flex flex-col items-start'>
                                          ...
                                          <p className='relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400'>
                                            ...
                                            their environments. From the graceful movements of marine life in the depths
                                            of the ocean to the impressive feats of birds soaring through the sky,
                                            animals captivate us with their beauty, agility, and innate survival
                                            instincts.
                                          </p>
                                          <div
                                            aria-hidden='true'
