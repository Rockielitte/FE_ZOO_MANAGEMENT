...
export const SpeciesCard = (props: Props) => {
  return (
    <div className='species-img bg-[url(@/assets/lin.jpg)] bg-center bg-cover box-content min-w-[330px] min-h-[200px] p-4 border-4 rounded-[1rem]'>
    <div className='flex justify-between flex-col h-full p-3'>
      ...
      <div className='font-normal flex space-x-3'>
        <Link to={`/dashboard/animal_species/${props.id}`} className={buttonVariants({ variant: "secondary" })}>View</Link>
